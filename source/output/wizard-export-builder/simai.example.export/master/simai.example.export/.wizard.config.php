...
return array(
    "description" => array(
        "name" => "Мастер упаковки SIMAI Example",
        "code" => "simai_example_export",
        "stage_renew" => "Y",
    ...
    "action" => array(
        array(
            ...
            "parameter" => array(
                array(
                    ...
                    "destination" => "/.last_version/simai.example.export/install/bitrix/components/simai",
                    "name" => "Копирование компонентов SIMAI",
                ),
                array(
                    "source" => "/bitrix/templates/.default",
                    "destination" => "/.last_version/simai.example.export/install/bitrix/templates/.default",
                    "name" => "Копирование шаблона .default",
                ),
                array(
                    "source" => "/upload/medialibrary",
                    "destination" => "/.last_version/simai.example.export/install/ru/root/upload/medialibrary",
                    "name" => "Копирование медиабиблиотеки",
                ),
                array(
                    "source" => "/bitrix/modules/simai.sf4university",
                    "destination" => "/.last_version/simai.example.export/install/bitrix/modules/simai.sf4university",
                    "name" => "Копирование модуля simai.sf4university",
                ),
                array(
                    "source" => "/bitrix/modules/simai.backup",
                    "destination" => "/.last_version/simai.example.export/install/bitrix/modules/simai.backup",
                    "name" => "Копирование модуля simai.backup",
                ),
                array(
                    "source" => "/bitrix/modules/simai.property",
                    "destination" => "/.last_version/simai.example.export/install/bitrix/modules/simai.property",
                    "name" => "Копирование модуля simai.property",
                ),
                array(
                    "source" => "/bitrix/modules/simai.property4iblock",
                    "destination" => "/.last_version/simai.example.export/install/bitrix/modules/simai.property4iblock",
        ...
        array(
            ...
            "parameter" => array(
                array(
                    "source" => "/ru",
                    "destination" => "/.last_version/simai.example.export/install/ru/site",
                    "name" => "Копирование публичных файлов",
                ),
                array(
                    "source" => "/urlrewrite.php",
                    "destination" => "/.last_version/simai.example.export/install/ru/config/urlrewrite.php",
        ...
        array(
            ...
            "parameter" => array(
                ...
                "destination" => "/.last_version/simai.example.export/install/iblock",
            ),
        ),
        ...
        array(
            ...
            "parameter" => array(
                "file" => "/.last_version/simai.example.export/install/ru/config/.site.config.php",
            ),
        ),
        ...
        array(
            ...
            "parameter" => array(
                "file" => "/.last_version/simai.example.export/install/ru/config/.usergroup.config.php",
            ),
        ),
        ...
        array(
            ...
            "parameter" => array(
                "file" => "/.last_version/simai.example.export/install/ru/config/.option.config.php",
            ),
        ),
        ...
        array(
            ...
            "parameter" => array(
                "file" => "/.last_version/simai.example.export/install/ru/config/.iblocktype.config.php",
            ),
        ),
        ...
        array(
            ...
            "parameter" => array(
                array(
                    "dir" => "/.last_version/simai.example.export/install/ru/php_interface",
                    "filename" => "dbconn.add.php",
                    "text" => "define(\"SF_SOLUTION\",\"simai.example.export\");",
                )
            ),
        ),
        ...
        array(
            ...
            "parameter" => array(
                    "/.last_version/simai.example.export/"
            ),
        ),
