...
- Task: `sf4 universal wizard visual standard`
- Objects: 10
- Relations: 22
...
- `gate.sf4.regression-readiness` (0.33): Blocks completion until SF4 page/component changes have component map, regression and runtime evidence.
- `capability.sf4.page-assembly` (0.18): Build SF4 pages through simai.data, grid/view/block composition and component templates.
- `capability.sf4.config-data` (0.18): Work with site/section/page properties, iblock/highloadblock setup, storage API and simai.data runtime settings.
