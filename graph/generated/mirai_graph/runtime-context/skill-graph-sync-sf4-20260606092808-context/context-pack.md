...
- Task: `создать SF4 universal wizard specialist обучить на source/wizard встроить в Mirai Graph federation`
- Objects: 10
- Relations: 22
...
- `capability.sf4.universal-wizard-specialist` (1.0): Create, modify, package, visualize and audit SF4 universal master flows, including action contracts, iblock/highload archive import/export, payload assembly and wizard visual configuration.
- `skill.sf4.core` (0.87): Owns SIMAI Framework 4 on Bitrix: simai.data, grid/view/block page assembly, components, iblock/HL setup, wizard actions and modernization workflows.
...
- `capability.sf4.wizard-actions` (0.72): Plan and implement wizard actions, migration notes and update artifacts for SF4 projects.
